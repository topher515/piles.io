...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'File.path'
        db.add_column('shinybox_file', 'path',
                      self.gf('django.db.models.fields.CharField')(default='inbox', max_length=1024),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'File.path'
        db.delete_column('shinybox_file', 'path')
    ...
    models = {
        ...
        'shinybox.file': {
            ...
            'path': ('django.db.models.fields.CharField', [], {'default': "'inbox'", 'max_length': '1024'}),
