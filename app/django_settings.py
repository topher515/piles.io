...
DATABASES = {
    'default': {
        ...
        'NAME': 'blah.db',                      # Or path to database file if using sqlite3.
...
ADMIN_MEDIA_PREFIX = settings['STATIC_URL']+'django-admin-media/'
...
SECRET_KEY = 'y9j6(7s@s+)u#_g&_@z17selg^!5v1ludunm5+0orz9o=68x#$'
